    ...
    <%@ page isELIgnored="false"%>
        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-warning">
                <div class="container">
                    <a class="navbar-brand fs-1 fw-medium" href="#">Job Market</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form:form action="handleForm" method="post" modelAttribute="jobPost">
                                    <div class="mb-1">
                                        <label for="id" class="form-label">Post ID</label> <input
                                            type="text" class="form-control" id="id" name="id"
                                            required>
                                    </div>

                                    <div class="mb-1">
                                        <label for="profile" class="form-label">Post Profile</label>
                                        <input type="text" class="form-control" id="profile"
                                            name="profile" required>
                                    </div>

                                    <div class="mb-1">
                                        <label for="description" class="form-label">Post
                                            Description</label>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <select multiple class="form-select" id="techStack"
                                            name="techStack" required>
